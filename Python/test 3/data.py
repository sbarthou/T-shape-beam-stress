...
for alto in range(100, 3000, 10):
    for ancho in range(100, 1000, 10):
...
# df.to_excel('test 3/data.xlsx', index=False)

sigma = df[df['Sigma max (ton/m^2)'] <= df['Sigma adm (ton/m^2)']]
print(sigma.loc[sigma['Wpp viga (ton/m)'].nsmallest(5).index])